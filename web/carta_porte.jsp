            ...
            <div class="container">
                <div class="card" id="card">
                    ...
                    <form action="ServletCarta" method="post">
                        <div class="row white">
                            <div class="col s12 light-blue lighten-4">
                                <div class="row ">
                                    ...
                                    <select class="js-example-basic-single" name="BUQUE" required>
                                        <option value="" disabled selected>Datos Buque</option>
                                        <%
                            ...
                            for (int i = 0; i < lista.size(); i++) {
                                ...
                                lista.get(i).getLR();
                                 ...
                                 lista.get(i).getNOMBRE();
                                        ...
                                        <option value="<%= lista.get(i).getLR() %>"><%= lista.get(i).getNOMBRE()%></option>
                                        <%
                                            }
                        ...
                        <table border="1" class="table" id="tablaprueba">
                            ...
                            <thead class="thead-dark ">
                                <tr class="center">
                                    <th class="center" width="50%">Modalidad || Observaciones  || Codigo Region</th>
