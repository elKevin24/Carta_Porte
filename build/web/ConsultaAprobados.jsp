                ...
                <div class="col s12">
                    ...
                    <table id="example" border="1"   class="highlight responsive-table striped " >
                        ...
                        <%
                            ...
                            LinkedList<BeanCarta> lista = Carta.ConsultarAprobados();
                            ...
                            for (int i = 0; i < lista.size(); i++) {
                                ...
                                out.println("<td>" + "<a class='waves-effect waves-light btn-small' href=Detalle.jsp?consulta=" + lista.get(i).getRW_ID_RECEPCION() + ">" + "Ver" + "</a>" + "</td>");
